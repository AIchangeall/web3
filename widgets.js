...
//   3) 赞赏提示：累计浏览满 2 分钟后温和弹出一次「自愿赞赏」(微信收款码 assets/wxskm.jpg)，
...
(function () {
  ...
  function buildDOM() {
    ...
    // ---- 赞赏提示：累计浏览满 2 分钟，温和弹出一次「自愿赞赏」，可关闭且不再打扰 ----
    ...
    var SEEN_KEY = "cnh_tip_seen", MS_KEY = "cnh_browse_ms", LIMIT_MS = 2 * 60 * 1000;
