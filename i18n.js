...
(function () {
  const DICT = {
    ...
    "brand.tag":       ["专注 Web3 · 每日更新", "Focused on Web3 · updated daily"],
    ...
    "news.market":      ["行情数据", "Market data"],
    "news.geopolitics": ["地缘政治", "Geopolitics"],
    "news.more":        ["展开全部", "Show all"],
    "home.h1":             ["资讯关注", "News pulse"],
    "home.tag.hiring":     ["招聘", "HIRING"],
    "home.tag.industry":   ["资讯", "NEWS"],
    "home.tag.market":     ["行情", "MARKET"],
    "home.tag.geopolitics":["地缘", "GEO"],
